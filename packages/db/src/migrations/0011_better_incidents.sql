...
ALTER TABLE "incident" ADD COLUMN "resolved_at" DROP NOT NULL;--> statement-breakpoint
UPDATE "incident" SET "started_at" = "created_at";--> statement-breakpoint
UPDATE "incident" SET "ended_at" = "resolved_at" WHERE "resolved_at" IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "incident_ended_at_idx" ON "incident" USING btree ("ended_at");--> statement-breakpoint
CREATE INDEX "incident_status_page_incident_idx" ON "incident_status_page" USING btree ("incident_id");--> statement-breakpoint
CREATE INDEX "incident_status_page_status_page_idx" ON "incident_status_page" USING btree ("status_page_id");
