...
export const configurationRouter = {
    list: adminProcedure
        ...
        .handler(async () => {
            ...
            const mergedItems = Object.entries(CONFIG_DEFAULTS).map(([key, defaultValue]) => {
    ...
    get: adminProcedure
        .meta({
            openapi: {
                ...
                description: "Retrieve a specific configuration value by key. Admin only.",
            },
        })
    ...
    delete: adminProcedure
        .meta({
            openapi: {
                ...
                description: "Remove a configuration value (reset to default). Admin only.",
            },
        })
        .input(z.object({ key: z.string() }))
        .handler(async ({ input }) => {
