...
type UsersTableModel = ReturnType<typeof useUsersTableModel>;

function UsersTableDialog1({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
...
function UsersTableDataTable4({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
...
function UsersTableDataTable3({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
    ...
    return (
        <Table>
            <UsersTableDataTable4 model={model} />
        </Table>
    );
}

function UsersTableDataTable2({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
    ...
    return (
        <div className="overflow-hidden rounded-xl border bg-card shadow-sm">
            ...
            <UsersTableDataTable3 model={model} />
...
function UsersTableDialog5({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
...
function UsersTableView({ model }: { model: UsersTableModel }) {
    const {
        queryClient,
        searchQuery,
        setSearchQuery,
    ...
    return (
        <div className="mx-auto w-full max-w-6xl space-y-4">
            <UsersTableDialog1 model={model} />

            <UsersTableDataTable2 model={model} />

            <UsersTableDialog5 model={model} />
...
export function UsersTable() {
    const model = useUsersTableModel();
    return <UsersTableView model={model} />;
}
