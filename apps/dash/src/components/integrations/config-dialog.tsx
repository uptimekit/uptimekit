            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogPopup className="max-h-[90vh] overflow-y-auto sm:max-w-xl">
                    ...
                    <DialogPanel className="grid gap-4">
                        ...
                        <div className="flex items-center justify-between gap-4 rounded-lg bg-muted/50 p-4">
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    Inactive notifications stay assigned but do
                                    not send events.
                                </p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-center justify-between gap-4 rounded-lg bg-muted/50 p-4">
                            <div className="flex flex-col gap-1">
                                <Label htmlFor="notification-default">
                                    Default
                                </Label>
                                <p className="text-muted-foreground text-sm">
                                    Automatically select this notification for
                                    new monitors.
                                </p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-start gap-3 rounded-lg bg-muted/50 p-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    Add this notification to all current
                                    monitors without removing other assignments.
                                </p>
                            </div>
                        </div>
                    </DialogPanel>
