        ...
        <div className="grid gap-4">
            <div className="grid gap-4 sm:grid-cols-[1fr_7rem]">
                <div className="grid gap-1.5">
                    ...
                    <Input
                        ...
                        value={config.host || ""}
                        onChange={(event) =>
                            setConfigValue("host", event.target.value)
                        }
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-1.5">
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            setConfigValue("username", event.target.value)
                        }
                        placeholder="alerts"
                    />
                </div>
                ...
                <div className="grid gap-1.5">
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            setConfigValue("password", event.target.value)
                        }
            ...
            <div className="grid gap-1.5">
                ...
                <Input
                    ...
                    value={config.from || ""}
                    onChange={(event) =>
                        setConfigValue("from", event.target.value)
                    }
            ...
            <div className="grid gap-1.5">
                ...
                <Input
                    ...
                    value={config.to || ""}
                    onChange={(event) =>
                        setConfigValue("to", event.target.value)
                    }
