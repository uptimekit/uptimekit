        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormDescription>
                        Comma-delimited DNS resolvers. Cloudflare is used by
                        default.
                    </FormDescription>
                    <FormMessage />
                </FormItem>
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormDescription>
                        Optional answer value that must be present in the DNS
                        response.
                    </FormDescription>
                    <FormMessage />
                </FormItem>
...
function InstatusComponentField({
    ...
    const { data, isLoading, error } = useQuery({
        ...
        enabled:
            canLoadComponents &&
            componentsRequestedUrl === trimmedStatusPageUrl,
        retry: false,
        staleTime: 60_000,
    });
                    ...
                    <>
                        <FormItem className="flex flex-row items-center justify-between rounded-lg bg-muted/50 p-4">
                            <div className="space-y-0.5">
                                ...
                                <FormDescription>
                                    Receive an alert when your certificate is
                                    about to expire.
                                </FormDescription>
                            </div>
                            <FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Number of days before SSL
                                            certificate expiration to send a
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormDescription>
                            Define which HTTP status codes are considered "Up".
                            Example: "200-204, 301, 302". Default is 200-299.
                        </FormDescription>
                        <FormMessage />
                    </FormItem>
                )}
...
function useCreateMonitorFormModel({
    ...
    const getFormValuesFromInitialData = (): FormValues => {
        ...
        return {
            ...
            tags:
                defaults.tags?.map((t: any) =>
                    typeof t === "string" ? t : t.id,
                ) || [],
            notificationIds:
                defaults.notificationIds ||
                defaults.notifications?.map(
            ...
            <Dialog open={manageGroupsOpen} onOpenChange={setManageGroupsOpen}>
                <DialogContent className="sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create, nest, rename, and delete monitor groups
            ...
            <Dialog open={manageTagsOpen} onOpenChange={setManageTagsOpen}>
                <DialogContent className="sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create, edit, and delete monitor tags without
                            leaving this form.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogPanel>
