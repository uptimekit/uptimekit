            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                        Started on{" "}
                        {new Date(maintenance.startAt).toLocaleString()}
                    </p>
                </div>
                                    ...
                                    {maintenance.monitors.map((m) => (
                                        ...
                                        >
                                            ...
                                            <FontAwesomeIcon
                                                ...
                                                className="h-3 w-3 text-muted-foreground opacity-0 transition-all group-hover:opacity-100"
                                            />
                                        </Link>
                                    ))}
                                </div>
